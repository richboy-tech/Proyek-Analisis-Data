...
data = geolocation.drop_duplicates(subset=['geolocation_zip_code_prefix', 'geolocation_city', 'geolocation_state'])
...
# Title
st.markdown("<h1 style='text-align: center; color: #068DA9;'>E-Commerce Dashboard</h1>", unsafe_allow_html=True)
...
with tab3:
    ...
    with st.expander("See Explanation"):
        st.write('Dari grafik yang sudah dibuat, kesimpulannya adalah ada lebih banyak customer di bagian tenggara dan selatan. Informasi lainnya, ada lebih banyak customer di kota-kota yang merupakan ibu kota (São Paulo, Rio de Janeiro, Porto Alegre, dan lainnya).')

st.caption('Copyright (C) Apolonius M. P. 2024')
